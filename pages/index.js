    ...
    <div className="container">
      ...
      <div id="howItWorks">
        <p>
          ...
          We will attempt to send you a reminder the evening before your court hearing. Case numbers are 14 characters long like: 123-45-678. Ticket numbers can be 5 to 9 digits long.
        </p>
        <div id="testcase">
      ...
      <p className="faq">
        <b>Who maintains CourtBotVT</b><br />
